    ...
    return (
      <div>
        <div id="topicContainer">
          <div className="likesDiv">{remainingLikes >= 0 ?  <h1 className="likesHeader">You have {remainingLikes} votes remaining</h1>:
           <h1 className="likesHeader">You have 0 votes remaining</h1>}
